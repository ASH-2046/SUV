...
def setup_logging(
    ...
    In distributed evaluation, only the main process outputs logs while other processes are silenced.
    ...
    Example:
        ...
        # In a distributed evaluation process
